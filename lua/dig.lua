...
-- dump info structure. Ex:
-- ;; Query time: 16 msec
-- ;; SERVER: 2001:7fd::1#53(k.root-servers.net) (UDP)
-- ;; WHEN: Thu Sep 18 15:49:24 CEST 2025
-- ;; MSG SIZE  rcvd: 811
local function dump_info(info)
    print(string.format("\n;; Query time: %d msec", info.elapsed))
    print(string.format(";; SERVER: %s (%s)", info.netinfo.peer_s, info.mode))
    print(string.format(";; MSG SIZE  rcvd: %d", info.netinfo.received))
end
