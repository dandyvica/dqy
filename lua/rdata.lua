...
RData['LOC'] = { "version", "size", "horiz_pre", "vert_pre", "latitude1", "latitude2", "longitude1", "longitude2",
    "altitude1", "altitude2" }
RData['MESSAGE'] = {}
RData['MOD'] = {}
...
RData['RRSIG'] = { "type_covered", "algorithm", "labels", "ttl", "sign_expiration", "sign_inception", "key_tag", "name",
    "signature" }
RData['SOA'] = { "mname", "rname", "serial", "refresh", "retry", "expire", "minimum" }
RData['SRV'] = { "priority", "weight", "port", "target" }
RData['SSHFP'] = { "algorithm", "fp_type", "fingerprint" }
RData['SVCB'] = { "svc_priority", "target_name", "svc_params" }
RData['TKEY'] = { "algorithm", "inception", "expiration", "mode", "error", "key_size", "key_data", "other_size",
    "other_data" }
